export default {
  ...
  VERIFYCONTAINTHREE:
    ". Please check your mailbox and click on the link to activate your account then try again.",
  ...
  NEED_HELP: "Need help with your Helpdesk URL?",
  /* HelpLink Component */
  WELCOME: "Wondering what will be your helpdesk URL?",
  INSTRUCTIONS:
    "This is the URL where your help desk is installed. You can reach out to IT admin to know more.",
  FOOTER: "For more information, Please drop a mail to support@ladybirdweb.com",
